      ...
      return (
        <div className="info">
          ...
          <form>
            ...
            {number!==1?<button onClick={(e) => {e.preventDefault(); storeAnswer(-1);}}  aria-label="Previous Question" className="styleButton">Previous Question</button>:<div></div>}
            <button onClick={(e) => {e.preventDefault(); storeAnswer(1);}}  aria-label="Next Question" className="styleButton">Next Question</button>
          </form>
        </div>
      )
    }else {
